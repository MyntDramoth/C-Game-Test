...
set files=src\glad.c src\main.c src\engine\global.c src\engine\time.c %io% %render% %config% %input% %physics% %array_list% %entity%
set libs=C:\Users\zachm\OneDrive\Desktop\C-Game-Test\lib\SDL2main.lib C:\Users\zachm\OneDrive\Desktop\C-Game-Test\lib\SDL2.lib
