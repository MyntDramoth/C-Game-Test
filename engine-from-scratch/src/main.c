...
int main(int argc, char* argv[]) {
	...
	usize player_id = entity_create((vec2){100,200},(vec2){24,24}, (vec2){0,0}, COLLOSION_LAYER_PLAYER, player_mask, player_on_hit, player_on_hit_static);
	...
	usize entity_a_id = entity_create((vec2){200,200},(vec2){25,25}, (vec2){400,0}, COLLOSION_LAYER_ENEMY, enemy_mask, NULL, enemy_on_hit_static);
